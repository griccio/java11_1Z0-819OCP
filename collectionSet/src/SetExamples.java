...
// cast t to a TreeSet variable to invoke TreeSet methods
        TreeSet<Integer> treeSet = new TreeSet<>(Set.of(1, 10, 20, 50, 51));

// lower returns the greatest element < (less than) the parameter
// value or null if no smaller element exists
        System.out.println("Using lower with values " + treeSet.toString()+": "
                + treeSet.lower(1) + " : "
                + treeSet.lower(10) + " : "
                + treeSet.lower(20) + " : "
                + treeSet.lower(50) + " : "
...
// value or null if no greater element exists
        ...
        TreeSet<String> t1 = new TreeSet(Set.of("jacket","trousers","shirt","suit"));

        System.out.println(t1.lower("jeans")); //jacket
        System.out.println(t1.lower("robe"));  //jacket
        System.out.println(t1.lower("shoes")); //shirt
