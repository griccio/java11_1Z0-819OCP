...
public class WrapperClassAssignements {
    ...
    public static void main(String[] args) {
        WrapperClassAssignements w = new WrapperClassAssignements();
...
/**
 bWrapperVariable = true
 bWrapperVariable2 = true
 bPrimitiveVariable = false
 Boolean Wrapper Value = true
 boolean Value = true
 */