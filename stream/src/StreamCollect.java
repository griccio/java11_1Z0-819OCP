...
public class StreamCollect {
    ...
    // beginning/ending bracket
        ...
        DoubleSummaryStatistics gpaStats = Stream.of(new Student("Jeff", 2.7f),
                        new Student("Carol", 3.5f),
                        new Student("Andy", 1.7f))
                .collect(Collectors.summarizingDouble(s ->s.getGpa()));
...
/**
 ...
 Collectors.joining - with no parameters: FirstSecondThird
 Collectors.joining - with delimiter : First, Second, Third
 Collectors.joining - with delimiter, prefix and suffix : List [First, Second, Third]
 ---- .collect(Collectors.averaging) examples ----
 average of random integers = 50476.339
 Average GPA = 2.63
 ---- .collect(Collectors.summarizing examples ----
 IntSummaryStatistics{count=1000, sum=47639906, min=29, average=47639.906000, max=99862}
 IntSummaryStatistics{count=1000, sum=51536321, min=97, average=51536.321000, max=99986}
 DoubleSummaryStatistics{count=3, sum=7.900000, min=1.700000, average=2.633333, max=3.500000}
 */
