...
public class FI_from_API_Predicate {

    public static void main(String[] args) {
        FI_from_API_Predicate fiAPI = new FI_from_API_Predicate();
//        fiAPI.predicate();
//        fiAPI.supplier();
//        fiAPI.consumer();
//        fiAPI.function();
    ...
    public void predicate() {
        ...
        String str1 = "Vatican City";
        Predicate<String> pStrMr = str1::contains;
        System.out.println(pStrMr.test("City"));//true
    ...
    public void unaryBinaryOperator() {
        ...
        UnaryOperator<Integer> incr = i -> i + 1;
        System.out.println(incr.apply(100));
