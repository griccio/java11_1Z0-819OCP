...
public class LambdaExamples3 {
    ...
    // Constructor
    LambdaExamples3(int instanceInt) {
        this.instanceInt = instanceInt;
    }

    public static void main(String[] args) {

        LambdaExamples3 lambdaExample =
                new LambdaExamples3(100);
        ...
        Runnable r2 = (a) -> a + LambdaExamples3.staticInt++;
...
/**
 Example 1 : r.run(a) = 6
 Example 2 : r.run(a) = 55
 Example 3 : r.run(a) = 56
 Example 4 : r.run(a) = 105
 Example 5 : r.run(a) = 106
 Example 6 : r.run(a) = 15
 Example 7 : r.run(a) = 21
 Example 8 : r.run(a) = 22
 */